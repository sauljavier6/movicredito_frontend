...
export default function ContractPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#eef7ff] via-white to-[#f7f9fc] px-4 py-10 sm:px-6 lg:py-16">
        ...
        {contract && (
          <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_300px]">
            <div className="rounded-[32px] bg-white p-6 shadow-sm ring-1 ring-black/5 sm:p-8">
              ...
              <div className="mt-6 max-h-[680px] overflow-y-auto rounded-3xl border border-black/5 bg-[#fbfcfe] p-6 sm:p-8"><div className="whitespace-pre-wrap font-sans text-[15px] leading-8 text-slate-700">{contract.contractText}</div></div>
              <details className="mt-4 text-xs text-black/35"><summary className="cursor-pointer select-none">Información de integridad del documento</summary><p className="mt-2 break-all rounded-xl bg-black/[.025] p-3">SHA-256: {contract.documentHash}</p></details>
            </div>
            ...
            <aside className="h-fit rounded-[32px] bg-slate-950 p-7 text-white lg:sticky lg:top-28">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-300">Al aceptar se registra la versión, integridad del documento, fecha y evidencia técnica de la operación.</p><div className="mt-5 flex items-start gap-3 rounded-2xl bg-white/10 p-4 text-xs leading-5 text-white/70"><LockKeyhole className="mt-0.5 shrink-0" size={16}/>Tu aceptación queda asociada exactamente a esta versión del contrato.</div>
